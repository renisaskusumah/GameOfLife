...
public class GoL {
    ...
    public class MyCanvas extends Canvas {
        private final int width = 600; // width of grid
        private final int height = 600; // height of grid
        public MyCanvas(){
            setLocation(0,32);
            ...
            addMouseListener(new MouseInputAdapter() {
                ...
                public void mouseExited(MouseEvent e)  { game.stop();}
                public void mouseEntered(MouseEvent e) { game.start();}
            });
        }
